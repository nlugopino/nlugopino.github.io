...
(function ($) {
    ...
    function createTableFooterPagination(idTable, nTdsColspan, last) {
        var pagination = "<span><button class='btn btn-success btn-sm paginationInit'><i class='fas fa-angle-double-left'></i></button></span> ";
        for (var i = 1; i <= last; i++) {
            pagination += "<span><button class='btn btn-success btn-sm paginationClick'>" + i + "</button></span> ";
        }
        pagination += "<span><button class='btn btn-success btn-sm paginationEnd'><i class='fas fa-angle-double-right'></i></button></span>"
    ...
    $.fn.paginationTdA = function (options) {
        ...
        createTableFooterPagination(idTable, 5, last);
